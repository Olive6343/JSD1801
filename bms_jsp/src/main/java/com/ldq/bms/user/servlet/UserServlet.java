package com.ldq.bms.user.servlet;
...
import com.ldq.bms.user.service.UserService;
import com.ldq.bms.user.service.impl.UserServiceImpl;
...
public class UserServlet extends HttpServlet {
	...
	private void search(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		LOGGER.info("试试....",request.getParameter("name"),request.getParameter("idCard"),request.getParameter("status"));
//		List<UserInfo> list = userService.searchUserInfoByName(request.getParameter("keywords"));
		List<UserInfo> list = userService.searchUserInfoByNameOrIdCardOrStatus(request.getParameter("name"),request.getParameter("idCard"),request.getParameter("status"));
		String listJson = "{\"total\":" + list.size() + ", \"rows\":" + gson.toJson(list, listType) + "}"; 
