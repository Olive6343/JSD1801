package com.ldq.bms.user.service.impl;

import java.util.ArrayList;
import java.util.List;

import com.ldq.bms.user.dao.UserDAO;
import com.ldq.bms.user.dao.impl.UserDAOImpl;
...
public class UserServiceImpl implements UserService {
	...
	public List<UserInfo> searchUserInfoByNameOrIdCardOrStatus(String name, String idCard, String status) {
		return userDAO.searchUserInfoByNameOrIdCardOrStatus(name, idCard, status);
	}
}
