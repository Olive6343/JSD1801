...
import com.ldq.jdbcdemo.dao.TransferMysqlDao;
import com.ldq.jdbcdemo.util.DBUtil;

//import m;

public class TransferMysqlDaoImpl implements TransferMysqlDao {
	...
	public boolean transfer(Long inId, Long outId, double money) {
		...
		try {
			...
			// 注册输出参数
			cs.registerOutParameter(4, Mysql.);
			// 4.编译并执行存储过程
			cs.execute();
	...
	public static void main(String[] args) {
		...
		System.out.println(transferDao.transfer(1L, 2L, 3000));
	}
}
